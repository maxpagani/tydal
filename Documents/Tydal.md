...
String Type construct is a kind of type definition used to declare string specialization. There is no mechanism to define the inner structure or the interface of these types, since this Is defined to be out of scope.
